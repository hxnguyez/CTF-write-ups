...
<img width="897" height="607" alt="image" src="https://github.com/user-attachments/assets/65450f54-92ab-4f73-b128-96dc403c7856" />
Decription: It's a race against time. Solve the binary exploit ASAP.

```ssh -p port ctf-player@green-hill.picoctf.net``` using password ```password```
